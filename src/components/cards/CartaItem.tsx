      ...
      <footer className="flex flex-col gap-4 p-4">
        ...
        {!isComplement && (
          <div className="flex flex-col gap-2 lg:hidden">
            <button
              onClick={() => handleAddToCart(`${item.slug}-10`, `${item.nombre} - 10 piezas`, 25, item.img)}
            ...
            <button
              onClick={() => handleAddToCart(`${item.slug}-6`, `${item.nombre} - 6 piezas`, 18, item.img)}
        ...
        {isComplement && (
          <div className="flex flex-col gap-2 lg:hidden">
            <button
              onClick={() => handleAddToCart(`${item.slug}`, item.nombre, item.price || 0, item.img)}
              className="group flex items-center justify-between rounded-xl bg-[#c89b3c] px-4 py-3 text-black"
            >
              <div className="text-left">
